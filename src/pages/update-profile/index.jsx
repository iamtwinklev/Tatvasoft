  ...
  return (
    <div>
      <div className="container">
        <Typography variant="h4" style={{color: "#f44403",marginTop: "50px", marginBottom: "50px"}}>Update Profile</Typography>
        <Formik
            ...
            <>
              <form action="" onSubmit={handleSubmit}>
                <div>
                  ...
                  <div className="inputValues1">
                    <TextField
                    style={{
                      marginBottom: "20px",marginRight: "50px",
                    }}
                      id="first-name"
                      name="firstName"
                      label="First Name *"
